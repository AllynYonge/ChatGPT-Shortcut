...
const Users: User[] = [
  ...
  },
  {
    ...
    "des_cn": '用户很难将视频上传到我们的视频编辑软件。有什么想法可以让它变得更容易？',
    "remark": '问题探索和想法产生',
    "title_en": 'Problem exploration and idea generation',
    "desc_en": 'Users are struggling to [upload videos to our video editing software]. What are some ideas to make it easier?',
    "remark_en": 'Problem exploration and idea generation',
    "preview": null,
    "website": 'https://github.com/f/awesome-chatgpt-prompts#act-as-a-product-manager',
    "source": null,
    "tags": ['pm','mind'],
